  ...
  return (
    <section className="w-full ">
      <div className="min-h-[60vh] relative  flex flex-col items-center justify-center gap-10">
        <div className=" flex mt-10  items-center flex-col gap-3">
        ...
        <Button className=" sm:h-12 text-lg bg-[#23CFA6] " size="lg">
          Check Courses-Make an Impact
        </Button>
        <div className="absolute top-[38vh] right-[10vw]  text-xs flex flex-col items-start">
          <p>
            Get ready to{" "}
      ...
      <div className="h-[30vh] py-4 flex justify-between  flex-col">
