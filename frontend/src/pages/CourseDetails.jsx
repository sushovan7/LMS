...
<section className="w-[80vw] shrink-0 flex flex-col  gap-6  h-full md:w-80">
  <Skeleton className="flex flex-col  bg-[#171717] gap-3 overflow-hidden w-full h-full rounded-lg">
    ...
    <div className="h-[40%]  flex py-2 justify-between flex-col">
      ...
      <div className="flex items-center px-2 justify-between">
        ...
        <h1 className="text-black bg-white px-2 py-1  rounded-md">41% off</h1>
      </div>
    </div>
  </Skeleton>

  <Skeleton className=" h-14 text-xl rounded-lg bg-[#23CFA6] " size="lg">
    View Details
  </Skeleton>
</section>;
